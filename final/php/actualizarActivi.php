...
$codigoA = $_POST['codigoAu'];
$descripcion = $_POST['descripcionu'];
$nombreA = $_POST['nombreAu'];
$fechainicio = $_POST['fechainiciou'];
$fechafin = $_POST['fechafinu'];
...
$sqlInsertar = "UPDATE Actividad SET codigoA='$codigoAu', descripcion='$descripcionu', nombreA='$nombreAu', fechainicio='$fechainiciou', fechafin='$fechafinu', estado='$estado' where codigoA='$codigoA'";
