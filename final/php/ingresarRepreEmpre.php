...
$sqlInsertar = "INSERT INTO RepresentanteEmpresa (cedulaRep,codigoPro,codigoE, nombreR, apellidoR, correo, telefono)
VALUES ('$cedula', $id, $codigoE, '$nombre','$apellido', '$correo', '$telefono')"or die('No se realizo la consulta');
...
header("Location: plantilla.php?op=10");
