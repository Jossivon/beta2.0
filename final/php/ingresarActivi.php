...
$sqlInsertar = "INSERT INTO Actividad (codigoA,codigoC,descripcion, nombreA, fechaInicio, fechafin, estado) VALUES ('$codigoA','$codigoc', '$descripcion', '$nombre', '$fechaInicio', '$fechaFin', '$estado')";
