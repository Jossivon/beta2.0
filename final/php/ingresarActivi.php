...
$sqlInsertar = "INSERT INTO Actividad (codigoA,codigoC,descripcion, nombreA, fechaInicio, fechafin, estado) VALUES ('$codigo','$codigoc', '$descripcion', '$nombre', '$fechaInicio', '$fechaFin', '$estado')";
