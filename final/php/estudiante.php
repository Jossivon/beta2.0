              ...
              <div class="form-group">
                <div class="input-group">
                    <div class="input-group-addon"><i class="fa fa-bussines-time"></i></div>
                      <input type="text" class="form-control input-lg" name="cargaHoraria" id="carga" placeholder="Carga Horaria" required>
                </div>
              </div>
...
<div class="modal fade" id="modalEditar"  role="dialog" >
  <div class="modal-dialog">
    <div class="modal-content">
     <form  role="form" method="POST" enctype="multipart/form-data" action="actualizar.php" onsubmit="return validarEditarUsuarios()">
       <div class="modal-header" style="background: #39CCCC; color:white">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
